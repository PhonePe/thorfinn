...
import com.thorfinn.cvss.FindingSeverityService;
...
public class  Orchestrator {
    ...
    public void execute(String packageName, int timeLimit, String configPath, PocApprovalMode pocMode, String reportPath, boolean diffMode) throws Exception {
        ...
        log.info("[*] Step 6: Calculating CVSS v4.0 severity scores for findings...");
        FindingSeverityService severityService = new FindingSeverityService();
        severityService.assignSeverities(results);
        log.info("[*] Step 7: Generating HTML report...");
        HtmlReportGenerator reportGenerator = new HtmlReportGenerator();
        reportGenerator.generateReport(results, manifestInfo);
        log.info("[*] Step 7.1: Generating JSON report...");
